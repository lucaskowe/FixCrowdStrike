...
Remove-Item -Path "C:\Windows\System32\drivers\C-00000291*.sys" -Force -Recurse -ErrorAction SilentlyContinue -Confirm:$false
#Verify file no longer exists and is removed
if (-not (Test-Path "C:\Windows\System32\drivers\C-00000291*.sys")) {
